/**
 * PLANIX V5 ACADEMIC HUB — Fully Responsive Reference UI View
 * Utilizes responsive CSS class structures (ah-summary-grid, ah-row1-grid, etc.)
 * to guarantee zero horizontal scroll across all device viewports (320px – 1920px+).
 */
      ...
      <div class="view-container animate-fade-in ah-container">
        ...
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px; flex-wrap: wrap; gap: 12px;">
          <div style="display: flex; align-items: center; gap: 12px;">
            <div style="width: 36px; height: 36px; border-radius: 8px; background: rgba(255, 45, 45, 0.15); display: flex; align-items: center; justify-content: center; color: var(--red); flex-shrink: 0;">
          ...
          <div>
            <button class="btn btn-primary" style="background: var(--red); font-weight: 700; padding: 10px 16px; font-size: 12px; display: flex; align-items: center; gap: 8px; width: 100%; justify-content: center;" onclick="document.getElementById('ah-file-upload-input').click()">
        ...
        <!-- ================= ROW 0: TOP SUMMARY CARDS (RESPONSIVE) ================= -->
        ...
        <!-- ================= ROW 1: UPLOAD & AI OVERVIEW (RESPONSIVE) ================= -->
        <div class="ah-row1-grid">
          ...
          <div class="ah-card" style="padding: 20px; display: flex; flex-direction: column; align-items: center; justify-content: center; text-align: center; border: 2px dashed #2A2A35; background: rgba(18, 18, 23, 0.8);"
            ...
            <div style="width: 44px; height: 44px; border-radius: 50%; background: rgba(255, 45, 45, 0.1); color: var(--red); display: flex; align-items: center; justify-content: center; font-size: 20px; margin-bottom: 12px;">☁️</div>
            <div style="font-size: 14px; font-weight: 700; color: #FFF; margin-bottom: 4px;">Drop your academic files here</div>
            <div style="font-size: 11px; color: var(--text-muted); margin-bottom: 14px;">PDF, DOCX, PPTX, Images, ZIP up to 100MB</div>
            ...
            <div style="font-size: 10px; color: var(--text-muted); margin-top: 8px;">or drag and drop</div>
          </div>
              ...
              ${documents.slice(0, 4).map(d => `
                <div style="display: flex; justify-content: space-between; align-items: center; padding: 8px 10px; background: var(--bg-subtle); border-radius: 8px; border: 1px solid var(--border); cursor: pointer;" onclick="window.documentViewerModal.open('${d.id}')">
                  <div style="display: flex; gap: 8px; align-items: center; overflow: hidden;">
                    <span style="font-size: 10px; font-weight: 800; padding: 2px 4px; border-radius: 4px; background: var(--red); color: #FFF; flex-shrink: 0;">PDF</span>
                    <div style="overflow: hidden;">
                      <div style="font-size: 11px; font-weight: 600; color: #FFF; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">${d.title}</div>
                      <div style="font-size: 9px; color: var(--text-muted);">${d.pages || 20} pages • ${d.fileSize}</div>
                    </div>
                  </div>
                  <span style="font-size: 10px; font-weight: 600; color: ${d.status === 'analyzed' ? 'var(--green)' : 'var(--yellow)'}; flex-shrink: 0; margin-left: 6px;">${d.status === 'analyzed' ? 'Analyzed ✓' : 'Analyzing'}</span>
                </div>
              `).join('')}
            </div>
          </div>
          ...
          <div class="ah-card" style="padding: 16px; display: flex; flex-direction: column; align-items: center; justify-content: space-between; text-align: center;">
            ...
            <div style="position: relative; width: 80px; height: 80px; margin: 10px 0;">
              <svg class="circular-progress" width="80" height="80" viewBox="0 0 90 90">
              ...
              <div style="position: absolute; inset: 0; display: flex; flex-direction: column; align-items: center; justify-content: center;">
                <span style="font-size: 20px; font-weight: 800; color: #FFF;">78</span>
        ...
        <!-- ================= ROW 2: DOCUMENT INTELLIGENCE GRID (RESPONSIVE) ================= -->
        <div class="ah-row2-grid">
          ...
          <div>
            ...
            <!-- Documents Grid -->
            <div class="ah-doc-grid">
              ${filteredDocs.slice(0, 6).map(d => `
                <div class="ah-card" style="padding: 14px; display: flex; flex-direction: column; justify-content: space-between; min-height: 170px;">
                  <div>
                    ...
                    <div style="font-size: 10px; color: var(--text-muted);">${d.pages || 12} pages • ${d.fileSize}</div>
                  </div>
            ...
            <div class="ah-suite-grid">
              ...
              <div class="suite-card" onclick="window.analysisModal.open('${documents[0]?.id || 'doc_1'}')">
                ...
                <div>
                  ...
                  <div style="font-size: 10px; color: var(--text-muted);">Get instant summary</div>
                </div>
              </div>
              ...
              <div class="suite-card" onclick="window.analysisModal.open('${documents[0]?.id || 'doc_1'}')">
                ...
                <div>
                  ...
                  <div style="font-size: 10px; color: var(--text-muted);">Smart flashcards</div>
                </div>
              </div>
              ...
              <div class="suite-card" onclick="window.analysisModal.open('${documents[0]?.id || 'doc_1'}')">
                ...
                <div>
                  ...
                  <div style="font-size: 10px; color: var(--text-muted);">Generate quizzes</div>
                </div>
              </div>
              ...
              <div class="suite-card" onclick="window.analysisModal.open('${documents[0]?.id || 'doc_1'}')">
                ...
                <div>
                  ...
                  <div style="font-size: 10px; color: var(--text-muted);">Visualize concepts</div>
                </div>
              </div>
              ...
              <div class="suite-card" onclick="window.analysisModal.open('${documents[0]?.id || 'doc_1'}')">
                ...
                <div>
                  ...
                  <div style="font-size: 10px; color: var(--text-muted);">Study schedule</div>
                </div>
              </div>
              ...
              <div class="suite-card" onclick="window.store.setState({ isAiDrawerOpen: true })">
                ...
                <div>
                  ...
                  <div style="font-size: 10px; color: var(--text-muted);">Ask questions</div>
                </div>
              </div>
        ...
        <!-- ================= ROW 4: ANALYTICS ROW (RESPONSIVE) ================= -->
        <div class="ah-row4-grid">
          ...
          <div class="ah-card" style="padding: 14px;">
            ...
            <svg viewBox="0 0 200 50" width="100%" height="36">
          ...
          <div class="ah-card" style="padding: 14px; display: flex; align-items: center; justify-content: space-between;">
            ...
            <div style="position: relative; width: 44px; height: 44px; flex-shrink: 0;">
              ...
              <div style="position: absolute; inset: 0; display: flex; align-items: center; justify-content: center; font-size: 9px; font-weight: 800; color: #FFF;">76%</div>
            </div>
          </div>
          ...
          <div class="ah-card" style="padding: 14px; display: flex; flex-direction: column; justify-content: space-between; border-color: rgba(229,9,20,0.3);">
            <div>
              <div style="font-size: 11px; font-weight: 700; color: var(--red);">AI Recommendation</div>
              <div style="font-size: 11px; color: #FFF; font-weight: 600; margin-top: 2px;">Focus on Data Structures</div>
              <div style="font-size: 9px; color: var(--text-muted); margin-top: 2px;">Exam in 5 days. Review Traversals.</div>
            </div>
            <button class="btn btn-secondary" style="margin-top: 6px; font-size: 9px; padding: 4px; font-weight: 700;" onclick="window.analysisModal.open('doc_2')">
              View Study Plan
            </button>
          </div>
